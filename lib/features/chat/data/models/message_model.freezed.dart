...
mixin _$MessageModel {
  int get idMessage => throw _privateConstructorUsedError;
...
abstract class $MessageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int idMessage, String source, MessageType type});
}
...
class _$_MessageModel implements _MessageModel {
  ...
  @override
  String toString() {
    return 'MessageModel(idMessage: $idMessage, source: $source, type: $type)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, idMessage, source, type);
...
abstract class _MessageModel implements MessageModel {
  factory _MessageModel(
      {final int idMessage,
      final String source,
      final MessageType type}) = _$_MessageModel;
